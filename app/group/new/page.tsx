...
const DEMO_TEAMS = [
  'לירן וניר', 'דוד ויוסי', 'משה ואלון', 'רון ועידן',
  'תומר ושחר', 'אסף וגל', 'נועם ויניב', 'עומר ואדם',
  'גיל וליאור', 'איתי ודניאל', 'בר ושי', 'ירון ועמית',
  'מתן וטל', 'עידו ורועי', 'אוהד ונתנאל', 'בועז וכפיר',
];
